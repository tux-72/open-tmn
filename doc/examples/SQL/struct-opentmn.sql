...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=koi8r CHECKSUM=1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=koi8r;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2010-11-17  1:05:19
